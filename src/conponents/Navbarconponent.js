...
import CartDrawer from "../conponents/Drawer";
import {
  Bars3Icon,
  ShoppingBagIcon,
  XMarkIcon,
...
import { logoutuser } from "../libs/firebaseconfig";
        ...
        <div className="relative  flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            {user ? (
              ...
              <Link to="/signin">
                <Button className="rounded bg-slate-500 py-2 px-4 text-sm text-white data-[hover]:bg-sky-500 data-[active]:bg-sky-700">
                  Login
                </Button>
              </Link>
            )}
